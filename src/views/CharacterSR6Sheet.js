...
<section id="pane-stats" class="grid" role="tabpanel" aria-labelledby="tab-stats">
    <section class="fullwidth">
        <dl class="field">
            <div>
                <dt>Metatype</dt><dd><field-editable data-name="metatype"></field-editable></dd>
            </div>
            <div>
...
`;
class CharacterSR6Sheet extends SheetView {
    /**
    ...
    _validateCharacter (character) {
        if (!(character instanceof CharacterSR6)) {
...
if (!window.customElements.get('sheet-view-sr6')) {
    window.customElements.define('sheet-view-sr6', CharacterSR6Sheet);
}

export default CharacterSR6Sheet;
